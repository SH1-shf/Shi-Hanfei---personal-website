...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(254, 243, 199, 0.25) 0%, rgba(249, 115, 22, 0.15) 100%)';
...
function ProfileCardComponent({
  ...
  behindGlowColor = 'rgba(249, 115, 22, 0.45)', // Warm branding theme orange glow
  behindGlowSize,
  className = '',
  enableTilt = true,
